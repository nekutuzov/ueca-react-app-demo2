                        ...
                        <Row spacing="large" fill flexWrap="wrap">
                            ...
                            <Col spacing="medium" sx={{ flex: "1 1 400px", minWidth: "300px" }}>
                                ...
                                <TextField
                                    ...
                                    fullWidth
                                    onChange={(value) => { model.buttonText = value; }}
                                />
                                ...
                                <RadioGroup
                                    ...
                                    orientation="row"
                                    onChange={(value) => { model.variant = value as "text" | "outlined" | "contained"; }}
                                />
                                ...
                                <RadioGroup
                                    ...
                                    orientation="row"
                                    onChange={(value) => { model.size = value as "small" | "medium" | "large"; }}
                                />
                                ...
                                <Select
                                    ...
                                    fullWidth
                                    onChange={(value) => { model.color = value as Palette; }}
                                />

                                <Checkbox
                                    labelView="Disabled"
                                    checked={model.disabled}
                                    onChange={(checked) => { model.disabled = checked; }}
                                />

                                <Checkbox
                                    labelView="Full Width"
                                    checked={model.fullWidth}
                                    onChange={(checked) => { model.fullWidth = checked; }}
                                />
