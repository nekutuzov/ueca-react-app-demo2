...
type ColPropertiesEditorStruct = UIBaseStruct<{
    props: {
        spacing: Spacing;
    ...
    children: {
        spacingRadioGroup: RadioGroupModel<Spacing>;
        horizontalAlignRadioGroup: RadioGroupModel<ColHorizontalAlign>;
        verticalAlignRadioGroup: RadioGroupModel<ColVerticalAlign>;
        ...
        flexWrapRadioGroup: RadioGroupModel<FlexWrap>;
...
type ColPropertiesEditorParams = UIBaseParams<ColPropertiesEditorStruct>;
type ColPropertiesEditorModel = UIBaseModel<ColPropertiesEditorStruct>;

function useColPropertiesEditor(params?: ColPropertiesEditorParams): ColPropertiesEditorModel {
    const struct: ColPropertiesEditorStruct = {
        props: {
            id: useColPropertiesEditor.name,
            spacing: "medium",
        ...
        children: {
            spacingRadioGroup: useRadioGroup<Spacing>({
                labelView: "Spacing",
            ...
            horizontalAlignRadioGroup: useRadioGroup<ColHorizontalAlign>({
            ...
            verticalAlignRadioGroup: useRadioGroup<ColVerticalAlign>({
            ...
            flexWrapRadioGroup: useRadioGroup<FlexWrap>({
                labelView: "Flex Wrap",
...
const ColPropertiesEditor = UECA.getFC(useColPropertiesEditor);

export { ColPropertiesEditorParams, ColPropertiesEditorModel, useColPropertiesEditor, ColPropertiesEditor };
